...
Cartify is an AI Powered Shopping List App
...
```bash
npx create-next-app cartify --example "[https://github.com/THEJOHNCALEB/CartifyPage](https://github.com/THEJOHNCALEB/CartifyPage)"
```
...
- John ([@thejohncaleb](https://twitter.com/thejohncaleb))
